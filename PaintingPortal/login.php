...
if(!isset($_POST["submit"]))
{
   ...
   $result = mysqli_query($con,"SELECT id,name,email, password FROM users WHERE email = '$email' AND password='$pass'");
   if (!$result) {
	printf("Error: %s\n", mysqli_error($con));
	exit();
}
...
{	
        ...
        VALUES ('".$_POST["fullname"]."', '".$_POST["emailid"]."', 
        '".$_POST["contactno"]."', 
